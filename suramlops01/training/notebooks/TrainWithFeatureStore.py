...
# ``suramlops01/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.suramlops01.suramlops01-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.suramlops01.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.suramlops01.trip_dropoff_features",
